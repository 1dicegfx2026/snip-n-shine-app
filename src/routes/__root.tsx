...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GILT — Luxury Barber & Salon Booking" },
      {
        name: "description",
        content:
          "Book the city's best barbers and salons in seconds. Real-time availability, portfolios, reviews and deposits — no waiting rooms.",
      },
      { name: "author", content: "GILT Grooming Co." },
      { property: "og:title", content: "GILT — Luxury Barber & Salon Booking" },
      {
        property: "og:description",
        content:
          "Book the city's best barbers and salons in seconds. Real-time availability, portfolios, reviews and deposits.",
      },
